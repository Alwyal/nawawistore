          ...
          <div class="panel-body">
            <form action="" method="post" class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" class="form-login" name="nama" required>
                </div>
              </div>
              <div class="form-group">
                <label for="email" class="control-label col-md-3">Email</label>
                <div class="col-md-7">
                  <input type="email" class="form-login" name="email" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <textarea name="alamat" id="" cols="30" rows="4" class="form-login" required></textarea>
                </div>
              </div>
              <div class="form-group">
                <label for="telepon" class="control-label col-md-3">Telepon/HP</label>
                <div class="col-md-7">
                  <input type="text" class="form-login" name="telepon" required>
                </div>
              </div>
              <div class="form-group">
