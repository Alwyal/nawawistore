  ...
  <div class="col-md-6">
    <form action="" method="post">
      ...
      <div class="form-group">
        ...
        <select name="status" id="" class="form-control" placeholder="Pilih Status!">
          <option value="lunas">Sedang Dipacking</option>
          <option value="barang dikirim">Barang Telah Dikirim</option>
